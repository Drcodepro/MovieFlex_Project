...
constructor(){
  ...
  this.state ={
    movies: [{name:"The Avenger",rating:9.6,price:399,star:0,url:"https://upload.wikimedia.org/wikipedia/en/8/8a/The_Avengers_%282012_film%29_poster.jpg"},
    {name:"Forest Gump",rating:8.5,price:259,star:0,url:"https://upload.wikimedia.org/wikipedia/en/6/67/Forrest_Gump_poster.jpg"},
    {name:"The Dark Knight",rating:7.9,price:709,star:0,url:"https://upload.wikimedia.org/wikipedia/en/1/1c/The_Dark_Knight_%282008_film%29.jpg"},
    {name:"Spider Man(Home Coming)",rating:8.2,price:499,star:0,url:"https://upload.wikimedia.org/wikipedia/en/f/f9/Spider-Man_Homecoming_poster.jpg"},
    {name:"John wick 2",rating:7.6,price:599,star:0,url:"https://upload.wikimedia.org/wikipedia/en/3/31/John_Wick_Chapter_Two.png"},
    {name:"Rambo(Last Blood)",rating:6.9,price:459,star:0,url:"https://upload.wikimedia.org/wikipedia/en/b/b1/Rambo_-_Last_Blood_official_theatrical_poster.jpg"}]
